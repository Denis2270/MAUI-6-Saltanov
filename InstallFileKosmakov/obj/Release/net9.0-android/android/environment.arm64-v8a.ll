...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [36 x i8] c"com.companyname.installfilekosmakov\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [34 x i8] c"libaot-InstallFileKosmakov.dll.so\00", align 1
