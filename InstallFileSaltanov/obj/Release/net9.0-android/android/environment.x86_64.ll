...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x11e36fd98ff5c404, ; from name: InstallFileKosmakov.so
		i64 u0x63a9371cf37978ba, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-InstallFileKosmakov.dll.so
		ptr null; void* handle
	}, ; 67
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x37da6e71d1e90f2d, ; from name: aot-InstallFileKosmakov
		i64 u0x63a9371cf37978ba, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-InstallFileKosmakov.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x62ad5ab8a63e0ede, ; from name: aot-InstallFileKosmakov.dll.so
		i64 u0x63a9371cf37978ba, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-InstallFileKosmakov.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x63a9371cf37978ba, ; from name: libaot-InstallFileKosmakov.dll.so
		i64 u0x63a9371cf37978ba, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-InstallFileKosmakov.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x77df2d751ff645bd, ; from name: InstallFileKosmakov.dll.so
		i64 u0x63a9371cf37978ba, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-InstallFileKosmakov.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7dcdcd18973f0983, ; from name: aot-InstallFileKosmakov.so
		i64 u0x63a9371cf37978ba, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-InstallFileKosmakov.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa004f1447144712f, ; from name: libaot-InstallFileKosmakov.so
		i64 u0x63a9371cf37978ba, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-InstallFileKosmakov.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb701905afc7d97e8, ; from name: InstallFileKosmakov
		i64 u0x63a9371cf37978ba, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-InstallFileKosmakov.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc20f4e1e7f7436de, ; from name: libaot-InstallFileKosmakov
		i64 u0x63a9371cf37978ba, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-InstallFileKosmakov.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [36 x i8] c"com.companyname.installfilekosmakov\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [34 x i8] c"libaot-InstallFileKosmakov.dll.so\00", align 16
